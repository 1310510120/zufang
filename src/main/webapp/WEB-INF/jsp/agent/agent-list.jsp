				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${list}" var="item">
								<tr>
									...
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='/agent/${item.uid}/detail'">修改</button>
										<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='/agent/${item.uid}/rejectpass'">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
